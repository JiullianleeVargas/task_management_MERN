                    ...
                    <div className="flex items-center justify-between px-4 py-3">
                        <a href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span style={titleStyle}
                                className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">TechSpire</span>
                        </a>
                                    ...
                                    <li class="nav-item">
                                        <NavLink to={item.path} key={index} className="group" activeclassName="active">
                                            <div className="flex items-center">
                                                <div>{item.icon}</div>
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{item.name}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                )
